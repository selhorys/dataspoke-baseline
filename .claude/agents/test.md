...
Run Python lint explicitly with `scaffold/bin/lint-python.sh`. Integration-test health remains
enforced by `tests/integration/conftest.py`'s `require_server` fixture.
