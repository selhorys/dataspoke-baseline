...
PG_HOST=${DATASPOKE_EXAMPLE_PG_HOST:-dataspoke-example-postgresql}
PG_PORT=${DATASPOKE_EXAMPLE_PG_PORT:-9102}
PG_DB=${DATASPOKE_DEV_KUBE_DUMMY_DATA_POSTGRES_DB:-example_db}
PG_USER=${DATASPOKE_DEV_KUBE_DUMMY_DATA_POSTGRES_USER:-postgres}
PG_PASSWORD=${DATASPOKE_DEV_KUBE_DUMMY_DATA_POSTGRES_PASSWORD:-}
...
echo "  PG (source)  = ${DATASPOKE_EXAMPLE_PG_HOST:-?}:${DATASPOKE_EXAMPLE_PG_PORT:-?}"
