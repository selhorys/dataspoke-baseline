...
> the DataHub v1.6.0 source (shallow clone, ~1-3 min). Retry this task after it completes.
...
The full DataHub source (v1.6.0) lives in `ref/github/datahub/`. Use the reference lookup table in [reference.md](reference.md) §Reference Lookup Table to find the right files.
