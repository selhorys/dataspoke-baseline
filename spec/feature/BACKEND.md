...
> libraries, Temporal workflows, database schema, and infrastructure integration
> patterns that sit behind the API layer.
>
...
9. [Kafka Consumers](#kafka-consumers)
10. [WebSocket Feed Mechanism](#websocket-feed-mechanism)
...
The Kafka consumer runs as a separate process alongside Temporal workers in the
`dataspoke-workers` deployment. It commits offsets after successful processing
