...
/** Lock service URL: DATASPOKE_LOCK_URL override, else http://<ip>:9221 */
export function lockUrl(): string {
  return optional("DATASPOKE_LOCK_URL") || `http://${ingressIp()}:9221`;
}

/** Lock owner identifier: DATASPOKE_LOCK_OWNER override, else e2e-test-<USER> */
export function lockOwner(): string {
  return (
    optional("DATASPOKE_LOCK_OWNER") ||
