...
def test_init_openai_provider(mock_create, mock_embed) -> None:
...
@patch("src.shared.llm.client._create_embeddings_model")
@patch("src.shared.llm.client._create_chat_model")
def test_init_google_provider(mock_create, mock_embed) -> None:
    mock_create.return_value = MagicMock()
    mock_embed.return_value = MagicMock()
...
@patch("src.shared.llm.client._create_embeddings_model")
@patch("src.shared.llm.client._create_chat_model")
def test_init_anthropic_provider(mock_create, mock_embed) -> None:
    mock_create.return_value = MagicMock()
    mock_embed.return_value = MagicMock()
...
@patch("src.shared.llm.client._create_embeddings_model")
@patch("src.shared.llm.client._create_chat_model")
async def test_complete_returns_text(mock_create, mock_embed) -> None:
...
@patch("src.shared.llm.client._create_embeddings_model")
@patch("src.shared.llm.client._create_chat_model")
async def test_complete_with_system_prompt(mock_create, mock_embed) -> None:
    mock_model = AsyncMock()
...
@patch("src.shared.llm.client._create_embeddings_model")
@patch("src.shared.llm.client._create_chat_model")
async def test_complete_json_returns_dict(mock_create, mock_embed) -> None:
    mock_model = AsyncMock()
