...
Persistent lessons for the `security-reviewer` role, for coding-agent backends with no built-in
...
their own `.claude/agent-memory/security-reviewer/` instead — this is a separate,
