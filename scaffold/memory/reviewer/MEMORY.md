...
Persistent lessons for the `reviewer` role, for coding-agent backends with no built-in
...
their own `.claude/agent-memory/reviewer/` instead — this is a separate, independently-accumulated
store, not a mirror of it.
