...
| `governance` | `spec/feature/BACKEND.md` §Metrics Service, `spec/API.md` §Governance, `spec/feature/FRONTEND_GOVERNANCE.md`, `spec/USE_CASE_en.md` UC5 | `src/backend/metrics/`, `src/api/routers/spoke/governance.py`, `src/workflows/dags/metrics*.py`, `src/api/schemas/metrics.py`, `src/frontend/app/(app)/governance/` |
