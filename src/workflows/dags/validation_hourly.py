"""Airflow DAG: validation-hourly

Hourly validation tier. Lists all datasets with active validation configs
for the hourly tier, then fans out one run_validation task per dataset.
