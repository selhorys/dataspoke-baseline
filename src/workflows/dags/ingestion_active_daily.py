"""Airflow DAG: ingestion-active-daily

Daily active ingestion tier. Lists all datasets with active ingestion configs
for the daily tier, then fans out one run_ingestion task per dataset using
...
_DAG_ID = "ingestion-active-daily"
_TIER = "daily"
