"""Airflow DAG: validation-weekly

Weekly validation tier. Lists all datasets with active validation configs
for the weekly tier, then fans out one run_validation task per dataset.
