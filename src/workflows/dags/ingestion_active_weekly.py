"""Airflow DAG: ingestion-active-weekly

Weekly active ingestion tier. Lists all datasets with active ingestion configs
for the weekly tier, then fans out one run_ingestion task per dataset using
...
_DAG_ID = "ingestion-active-weekly"
_TIER = "weekly"
