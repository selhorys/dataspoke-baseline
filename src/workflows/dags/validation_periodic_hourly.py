"""Airflow DAG: validation-periodic-hourly

Periodic validation for the hourly schedule tier. Lists datasets due for hourly
...
""",
    ...
    run_validation = HttpOperator.partial(
