...
/**
 * The per-feature metagen detail surface moved to the unified /data/[urn] hub.
 * This route redirects, preserving deep links.
 *
 ...
 */
export default async function MetagenDatasetRedirect({
  params,
}: {
